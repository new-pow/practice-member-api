...
> 회원 가입과 인증 인가 과정은 다양한 Spring framework로 간편하게 할 수 있습니다.
> 그러나 해당 기능을 사용하기 전, 어떻게 작동하는지 파악해보고자 가장 기본적인 Member API를 직접 구현해 보았습니다.

## 주요 구현사항

### 사용자 로그인
- jwt 토큰을 사용한 인증인가를 구현하였습니다.
...
- validation을 위한 어노테이션을 직접 구현해보았습니다.
